    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-stone-50 overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            >
              ...
              >
                <div className="text-3xl font-bold text-amber-600"><AnimatedCounter value={10} suffix="K+" duration={2} />
                </div>
              ...
              <motion.div
                ...
                whileHover={{ scale: 1.1 }}
              >
                <div className="text-3xl font-bold text-orange-600"><AnimatedCounter value={5} suffix="K+" duration={2} />
                </div>
              ...
              <motion.div
                ...
                whileHover={{ scale: 1.1 }}
              >
                <div className="text-3xl font-bold text-amber-700"><AnimatedCounter value={50} suffix="K+" duration={2} />
                </div>
          ...
          >
            ...
            >
              <Floating duration={3} distance={5}>
                <div className="flex items-center gap-2">
                  <CheckCircle className="h-6 w-6 text-[#8b9c38]" strokeWidth={1.5} />
                  <div>
            ...
            >
              <Floating duration={2.5} distance={5}>
                <div className="flex items-center gap-2">
                  <TrendingUp className="h-6 w-6 text-amber-500" strokeWidth={1.5} />
                  <div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <SlideInLeft delay={0.1}>
                <HoverCard className="flex items-start gap-4 p-6 bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl">
                  <motion.div
                    className="h-12 w-12 bg-amber-500 rounded-lg flex items-center justify-center flex-shrink-0"
              ...
              <SlideInLeft delay={0.2}>
                <HoverCard className="flex items-start gap-4 p-6 bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl">
                  <motion.div
                    className="h-12 w-12 bg-orange-500 rounded-lg flex items-center justify-center flex-shrink-0"
                    whileHover={{ rotate: 360 }}
                    transition={{ duration: 0.5 }}
                  >
              ...
              <SlideInLeft delay={0.3}>
                <HoverCard className="flex items-start gap-4 p-6 bg-gradient-to-r from-yellow-50 to-amber-50 rounded-xl">
                  <motion.div
                    className="h-12 w-12 bg-amber-700 rounded-lg flex items-center justify-center flex-shrink-0"
                    whileHover={{ rotate: 360 }}
                    transition={{ duration: 0.5 }}
                  >
      ...
      <section id="tinh-nang" className="container mx-auto px-4 py-20">
        ...
        <StaggerContainer staggerDelay={0.1} className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            { icon: Building2, title: "Quản Lý Tòa Nhà", desc: "Quản lý nhiều tòa nhà và phòng trọ với thông tin chi tiết về diện tích, tiện nghi, giá thuê.", iconColor: "text-amber-500" },
            { icon: Users, title: "Quản Lý Người Thuê", desc: "Lưu trữ thông tin người thuê, theo dõi lịch sử thuê trọ và thanh toán dễ dàng.", iconColor: "text-[#8b9c38]" },
            { icon: FileText, title: "Hóa Đơn Tự Động", desc: "Tự động tạo hóa đơn điện, nước, tiền thuê hàng tháng và gửi thông báo cho người thuê.", iconColor: "text-amber-600" },
            { icon: TrendingUp, title: "Báo Cáo Doanh Thu", desc: "Xem báo cáo doanh thu, công nợ chi tiết với biểu đồ trực quan, dễ hiểu.", iconColor: "text-[#ed7307]" },
            { icon: Bell, title: "Thông Báo Tức Thời", desc: "Gửi và nhận thông báo về hóa đơn, bảo trì, thông tin quan trọng ngay lập tức.", iconColor: "text-[#90b1c4]" },
            { icon: Wrench, title: "Yêu Cầu Bảo Trì", desc: "Người thuê gửi yêu cầu sửa chữa, chủ nhà theo dõi và xử lý nhanh chóng.", iconColor: "text-[#bf4514]" },
            { icon: Lock, title: "Hợp Đồng Điện Tử", desc: "Tạo và lưu trữ hợp đồng thuê trọ điện tử, tiện lợi và có giá trị pháp lý.", iconColor: "text-amber-700" },
            { icon: Smartphone, title: "Đa Nền Tảng", desc: "Sử dụng mọi lúc, mọi nơi trên điện thoại, máy tính bảng hoặc máy tính.", iconColor: "text-orange-600" },
          ].map((feature, index) => (
            <StaggerItem key={index}>
              <HoverCard className="bg-white p-8 rounded-2xl shadow-sm border h-full">
                <motion.div
                  ...
                  transition={{ duration: 0.2 }}
                >
                  <feature.icon className={`h-9 w-9 ${feature.iconColor}`} strokeWidth={1.5} />
                </motion.div>
      ...
      <section id="quy-tac" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            {/* Quy tắc cho Chủ nhà */}
            <SlideInLeft>
              <HoverCard className="bg-gradient-to-br from-amber-50 to-orange-50 p-8 rounded-2xl border border-amber-200 h-full">
                <div className="flex items-center gap-3 mb-6">
                  <motion.div
                    className="h-12 w-12 bg-amber-500 rounded-xl flex items-center justify-center"
                    whileHover={{ rotate: 360 }}
                    transition={{ duration: 0.5 }}
                  >
                    <Building2 className="h-6 w-6 text-white" />
                  </motion.div>
                  <h3 className="text-2xl font-bold text-amber-900">Dành Cho Chủ Nhà</h3>
                </div>
          ...
          <FadeInUp delay={0.3} className="mt-8">
            <HoverCard className="bg-gradient-to-r from-stone-50 to-amber-50 p-8 rounded-2xl border border-stone-200">
              <div className="flex items-center gap-3 mb-6">
                <motion.div
                  className="h-12 w-12 bg-stone-600 rounded-xl flex items-center justify-center"
                  whileHover={{ rotate: 360 }}
                  transition={{ duration: 0.5 }}
                >
                  <Shield className="h-6 w-6 text-white" />
                </motion.div>
                <h3 className="text-2xl font-bold text-stone-800">Quy Tắc Chung</h3>
              </div>
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  ...
                  >
                    <motion.div whileHover={{ scale: 1.2 }}>
                      <CheckCircle className="h-5 w-5 text-stone-600 flex-shrink-0" />
                    </motion.div>
      ...
      <section className="container mx-auto px-4 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            { step: 1, title: "Đăng Ký Tài Khoản", desc: "Tạo tài khoản miễn phí với email hoặc số điện thoại trong vài phút.", gradient: "from-amber-500 to-orange-500", lineGradient: "from-blue-300 to-indigo-300" },
            ...
            <StaggerItem key={index}>
              <HoverCard className="bg-white p-8 rounded-2xl shadow-sm border h-full">
                ...
                <div className="flex items-center gap-4">
                  <motion.div
                    className="h-12 w-12 rounded-full border-2 border-amber-400 flex items-center justify-center font-bold text-amber-700 bg-amber-50 text-sm"
                    whileHover={{ scale: 1.1 }}
                  >
      ...
      <AnimatePresence>
        {!isChatOpen && (
          <motion.button
            ...
            className="fixed bottom-6 right-6 h-16 w-16 bg-gradient-to-r from-amber-500 to-orange-500 rounded-full shadow-2xl flex items-center justify-center text-white z-50"
          >
            ...
            <div className="p-4 border-t">
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="h-10 w-10 bg-gradient-to-r from-amber-500 to-orange-500 rounded-full flex items-center justify-center text-white disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-lg transition-shadow"
                >
